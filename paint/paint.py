...
pygame.display.set_caption("Adina's Paint")
...
# Variables
drawing = False
mode = "pencil"  #other drawing modes: rect, circle, line, square, r_triangle, e_triangle, rhombus
start_pos = None
prev_pos = None
thickness = 3  #drawing tool
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:  # Exit the program
            ...
            if event.key == pygame.K_1:
                ...
                pygame.image.save(canvas, "draw.png")
